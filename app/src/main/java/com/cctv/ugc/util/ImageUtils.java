...
public class ImageUtils {
    ...
    public static Bitmap applyBlur(Window window) {
        ...
        return blur(bmp2, window.findViewById(Window.ID_ANDROID_CONTENT));
    }

    private static Bitmap blur(Bitmap bkg, View view) {
         ...
         */
        DebugLog.log("lxtest", "blur time:" + (System.currentTimeMillis() - startMs));
